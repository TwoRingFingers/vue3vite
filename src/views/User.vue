<template>
  <div class="userPage">
    ...
    <div class="warpper-table">
      <el-table :data="model.datalist" style="width: 100%" class="table-sty">
        <el-table-column
          v-for="item in model.tableLabel"
          :key="item.prop"
        ...
        <el-table-column fixed="right" label="操作" min-width="120">
          <template #="scope">
            ...
            <el-popconfirm title="确定删除吗？" @confirm="deleteFun(scope.row)">
              <template #reference>
...
//新增
const add = () => {
  addRef.value.handleAdd(); // 调用子组件的方法
};
onMounted(() => {
  getUserFun();
});
